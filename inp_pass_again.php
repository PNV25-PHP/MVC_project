    ...
    <div class="container ">
        <div class="grid-cols-2 flex font-Poppins">
            ...
            <div class="block_contain-lefl col-span-1">
                ...
                <p>Vui lòng nhập lại email và mật khẩu mới</p>
                <!-- nhập thông tin -->
                <form action="" method="post" id="form">
                    ...
                    <button type="submit" class="flex bg-blue-900 mb-5 border border-2 rounded-lg border-blue-600 h-9" style="width: 500px;">
                        ...
                        <p class="text-white justify-center ml-3 mt-1">Đăng nhập bằng google</p><br>
                    </button>
                    <a href="#"  class="mb-2 text-center italic text-blue-900" style="width:500px">Quên mật khẩu?</a>
                </form>
